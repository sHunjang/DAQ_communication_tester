...
작성일: 2025-10-24
=================================================================
RS485/RS232 하드웨어 없이 통신을 시뮬레이션하기 위한 Mock 클래스입니다.
파일 시스템을 이용하여 독립된 프로세스 간 통신을 구현합니다.
...
class MockSerial:
    ...
    def _monitor_file(self):
        ...
        상대방이 파일에 데이터를 쓰면 자동으로 감지하여 읽기 버퍼에 추가합니다.
        """
...
def cleanup_mock_files():
    ...
    프로그램 시작 전이나 종료 후 호출하면 이전 테스트의 잔여 파일을 정리할 수 있습니다.
    """
